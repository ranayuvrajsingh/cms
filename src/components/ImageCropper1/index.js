  ...
  return (
    <div className={'image__cropper'}>
      ...
      <div className={'crop-container'}>
        <Cropper
          onMediaLoaded={!isPreviewMode1 ? onImageLoad : ''}
          image={imageSrc}
          crop={crop}
          rotation={rotation}
          zoom={zoom}
          classes={{
            containerClassName: isPreviewMode1 ? 'no-scroll-zoom' : '',
            cropAreaClassName: isPreviewMode1 ? 'hidden' : '',
            mediaClassName: isPreviewMode1 ? 'no-edit' : '',
          }}
          aspect={width/height}
