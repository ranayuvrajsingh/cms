  ...
  return (
    <div className={'image__cropper'}>
      ...
      <div className={'crop-container'}>
        <Cropper
          onMediaLoaded={!isPreviewMode ? onImageLoad : ''}
          image={imageSrc}
          crop={crop}
          rotation={rotation}
          zoom={zoom}
          classes={{
            containerClassName: isPreviewMode ? 'no-scroll-zoom' : '',
            cropAreaClassName: isPreviewMode ? 'hidden' : '',
            mediaClassName: isPreviewMode ? 'no-edit' : '',
          }}
          aspect={width/height}
